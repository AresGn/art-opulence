...
Dans la section projet recent et sur la page projet j'iamerais plutot que tu adopte ce design c'est plus cool et propre: You are given a task to integrate an existing React component in the codebase
...
Steps to integrate
 ...
 3. Use lucide-react icons for svgs or logos if component requires the